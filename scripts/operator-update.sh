...
install_missing "$SOURCE_PATH/templates/cursor/skills/operator-workflow/SKILL.md" "$TARGET_REPO/.cursor/skills/operator-workflow/SKILL.md" ".cursor/skills/operator-workflow/SKILL.md"
