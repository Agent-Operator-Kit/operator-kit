...
require(compatibility.get("projectKitVersion") == "5.2", "V5.2 compatibility version mismatch")
...
for adapter_path in adapter_paths:
    ...
    require("5.1" in adapter.get("compatibleProjectKitVersions", []), f"{host} must retain Operator Kit V5.1 compatibility")
    require("5.2" in adapter.get("compatibleProjectKitVersions", []), f"{host} must target Operator Kit V5.2")
